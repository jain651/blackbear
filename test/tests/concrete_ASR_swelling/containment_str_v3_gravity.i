...
[Mesh]
 file = gold/containment_structure/quarter_containment_wo_baseMat_liner_grade_refined.e
...
#
# nodeset 1 # disp_y zero
# nodeset 2 # disp_x zero
# nodeset 3 # disp_z zero
# nodeset 4 # outer surface
# nodeset 5 # dome outer surface
# nodeset 6 # cylinder outer surface
# nodeset 7 # base outer surface
# nodeset 8 # inner surfaces (no flux BC)
# nodeset 9 # outer surface for aboveground BC
# nodeset 10 # outer surface for underground BC first 2" depth (unscaled dimension)
# nodeset 11 # outer surface for underground BC between 2" and 4" depth (unscaled dimension)
# nodeset 12 # outer surface for underground BC between 4" and 8" depth (unscaled dimension)
# nodeset 13 # outer surface for underground BC between 8" and 20" depth (unscaled dimension)
# nodeset 14 # outer surface for underground BC below 20" depth (unscaled dimension)
# nodeset 15 # bottom surface of the structure
[]
...
# Dead load or other loading on containment_structure
# [NodalKernels]
#   [./force_dead]
#     type = ConstantRate
#     variable = disp_z
